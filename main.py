...
def main(args):
	set_seed(SEED)
	logging.basicConfig(filename=args.log_file, encoding='utf-8', level=logging.DEBUG, format='%(asctime)s - %(message)s', datefmt='%Y-%m-%d %H:%M:%S')
...
if __name__ == '__main__':
	...
	parser.add_argument('--chat_df_path',default='./data/chats_2021-04.csv')
